...
pc <- read_excel("Excel_files_from_Brad/Copy of B4BI_Pak_choi_seed_data_for_Heather (BH edit).xlsx") %>% 
  ...
  # )) %>%
  mutate(Simplified_Boundary=ifelse( (Farm=="Tweed" & Simplified_Boundary=="Control_farm"), "Bare_fence", Simplified_Boundary)) %>%
...
dairy_arable <- read_excel("Excel_files_from_Brad/Farm type and treatment for pak choi Heather update.xlsx", sheet="Sheet1", range="A3:C55") %>%
